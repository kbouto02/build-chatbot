...
sample_coverages=[
	...
	"aid": "Demonstration",
        ...
        "paid":"Demonstration",
        "acctname":"Demonstration",
        "ips": "Demonstration",
        "ipsm": "Demonstration",
        "ipssec": "Demonstration",
        "ipssecm": "Demonstration",
        "ipsturbo": "Demonstration",
        "ipsturbom": "Demonstration",
...
class CoverageModel(db.Model):
    ...
    ptscloudm = db.Column('PTSCLOUDM',db.String(255))
...
class CoverageInSchema(Schema):
    ...
    ipssecm = String(required=True, validate=Length(0, 255))
    ipsturbo = String(required=True, validate=Length(0, 255))
    ipsturbom = String(required=True, validate=Length(0, 255))
